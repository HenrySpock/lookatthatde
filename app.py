...
# app.config['MAIL_PORT'] = int(os.environ.get('MAIL_PORT', 465))  # Default to 465 if not set
# app.config['MAIL_USERNAME'] = os.environ.get('MAIL_USERNAME')
# app.config['MAIL_PASSWORD'] = os.environ.get('MAIL_PASSWORD')
# app.config['MAIL_USE_TLS'] = os.environ.get('MAIL_USE_TLS') == 'True'  # Convert string to boolean
# app.config['MAIL_USE_SSL'] = os.environ.get('MAIL_USE_SSL') == 'True'  # Convert string to boolean
